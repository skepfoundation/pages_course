...
This is what you get when DNS check is successful. ![DNS check successful](./lesson_images/image4.png)

|  |
|-----------------|
| After a successful DNS check as denoted by **1** in the image below, you can navigate to the website by clicking on **view site** as annotated. ![details in the image above](./lesson_images/image7.png) |

After a successful DNS check and viewing the url link, the image below will be the final result. ![website](./lesson_images/image8.png)
...
Note - Share any challenges you might be havin there too.
