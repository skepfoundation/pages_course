...
In summary, Markdown is a handy, versatile text-formatting tool that you can use to create websites and other textbased documents, which you'll be using throughout your data science journey. Knowing how to use it will prove essential as you kickstart your journey.
