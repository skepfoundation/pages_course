...
This lesson will not focus on markdown. In the next two lessons, you'll learn how to use Markdown to enhance the visual appeal and structure of your profile, making it easier for others to read and understand the information you share. 
...
5. Check the **Add a README file** checkbox. This will add a ```README.md``` file where we'll add the profile contents. The field values should look similar to the image below. Whatever you write in the `README.md` file using Markdown will appear on your GitHub profile.
