...
When the parameters listed above (Label and color) are combined with [https://img.shields.io/badge/](https://img.shields.io/badge/), the following URLs are created. For LinkedIn, `https://img.shields.io/badge/LinkedIn-blue`. For Twitter, `https://img.shields.io/badge/Twitter-blue`.
