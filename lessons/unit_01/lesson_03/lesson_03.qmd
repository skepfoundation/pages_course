...
1. For the first taks, you shall be recreating this documents--> [document](https://www.dropbox.com/scl/fi/urdglf9eg5kt9o0n4m05p/My-Favorite-Hobby_-Photography.pdf?rlkey=9nbv8ly365uzej9ymm0yjwjmm&dl=0) 
...
### Task 2:
For the second task, you are to carry out the following.

1.  

    #### **Headings**

-   Create a top-level heading with the text "Hello World."
-   Add a second-level heading with the text "This is my Markdown Journey."
-   Include a third-level heading with the text "Here We Go."
...
1.  Gather ingredients and tools: Bread, Peanut Butter, Jelly or Jam, Butter knife, Plate.
2.  Prepare the workspace: Lay out a clean surface.
3.  Spread Peanut Butter on one slice.
4.  Spread Jelly on the other slice.
5.  Combine the slices to make a sandwich.
6.  Serve and Enjoy.
...
-   Write a small Python code snippet inside a code block that prints "Markdown is fun!"
...
- Please make use of this link: [dilinger](https://dillinger.io/) to perform the tasks given to you. When you are done, click on the export button at the top right corner of the website and export your markdown file into a pdf format for submission. Submissions for all tasks should be done in your team channel.
  
- You can click on ***Create New Document*** on the left pane of the website to create new document. Be advised that the document created comes with a default code template, feel free to delete them and type in your codes to create a new markdown document.
![](./image1.png)
  
- When you are done Editing, save the document with your name and task number. In this format **"James_task01"**. That can be done by clicking on the file name at the top of the document, as shown in the image below.
